# Portable (folder) build – produces a small EXE launcher + a runtime folder.
# Build from the repository root with:
#   pyinstaller --clean --noconfirm WordTextReplacer_portable.spec
#
# Output: dist/WordTextReplacer/
#         ├── WordTextReplacer.exe   (small, ~1-3 MB)
...
# ---------- Collect runtime files into folder ----------
coll = COLLECT(
    exe,
    a.binaries,
    a.datas,
